...
<template>
  <div>
    <header>
      <div
        :class="`container md:mx-auto max-w-2xl box-content ${frontmatter.home ? '' : 'xl:pr-72'}`"
      >
    ...
    <div
      ...
      class="container md:mx-auto max-w-2xl box-content xl:pr-72"
    >
    ...
    <footer>
      <div
        :class="`container md:mx-auto max-w-2xl box-content py-16 ${
