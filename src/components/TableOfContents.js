...
function TableOfContents(props) {
  ...
  return React.createElement("ul", undefined, headings.filter(function (heading) {
                    if (heading.depth === 2) {
                      return true;
                    } else {
                  ...
                  return React.createElement("li", {
                              ...
                              className: "list-none px-2 py-1 my-1 block text-sm " + (
                                match !== 2 ? (
                                    match$1 ? "bg-blue-100 text-blue-500 rounded ml-2 font-bold" : "text-slate-700 ml-2"
                                  ) : (
                                    match$1 ? "bg-blue-100 text-blue-500 rounded font-bold" : "text-slate-700"
                                  )
                              ) + ""
