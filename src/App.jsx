  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-none">
        <Header.make isArticle={isArticle} />
      </div>
      <div className="flex-auto">{props.children}</div>
      <div className="flex-none">
        <Footer.make isArticle={isArticle} />
      </div>
    </div>
  );
}
    ...
    if (match) {
      switch (match.hd) {
        case 'latex':
          return (
            <App$Layout
              children={<Latex.make path={target.path} load={target.load} />}
              isArticle={true}
            />
          );
        case 'post':
          return (
            <App$Layout
              children={<Post.make path={target.path} load={target.load} />}
              isArticle={true}
            />
          );
        default:
