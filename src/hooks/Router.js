...
var context = React.createContext(
  RescriptReactRouter.dangerouslyGetInitialUrl(undefined, undefined),
);
...
function Router$Provider(props) {
  var url = RescriptReactRouter.dangerouslyGetInitialUrl(
    props.serverUrlString,
    undefined,
  );
...
function useUrl(param) {
  ...
  React.useEffect(function () {
    ...
    var newUrl = RescriptReactRouter.dangerouslyGetInitialUrl(
      undefined,
      undefined,
    );
